var win16 = Titanium.UI.createWindow({  
    title:'Sensor/Larm Objekt',
    backgroundColor:'#fff',
    zIndex:2
});

win16.orientationModes = [Titanium.UI.PORTRAIT];
...
win16.addEventListener('android:back',function() {
