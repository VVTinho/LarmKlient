var win24 = Titanium.UI.createWindow({  
    title:'Larmlista',
    backgroundColor:'#fff',
    zIndex:3
});

win24.orientationModes = [Titanium.UI.PORTRAIT];
...
xhr.onload = function() {
    ...
    for (s in objekten) {
        ...
        data.push(Titanium.UI.createTableViewRow({title: " Örestad Linux: " + objekten[s][0].ObjectName + " Larmtid:" + " Larmtyp:" + " Gräns:"}));
